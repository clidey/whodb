...
Additional agent docs: `.agents/docs/build-and-run.md` (CE setup and generation), `.agents/docs/cli.md` (CLI), `.agents/docs/desktop.md` (desktop), `.agents/docs/ci-cd.md` (GitHub Actions), `.agents/docs/testing.md` (testing), `.agents/docs/analytics.md` (PostHog analytics contract). For adding new data sources, follow `DATA_SOURCE_GUIDE.md` (EE-specific additions in `ee/.agents/docs/data-sources.md`).
