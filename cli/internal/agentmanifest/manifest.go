...
func buildMCPTools() []MCPTool {
	...
	tools = append(tools,
		...
		MCPTool{Name: "whodb_platform_packages", Description: "List hosted package versions available in the selected project.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_package", Description: "Inspect one hosted package and its requirements.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_package_installations", Description: "List hosted package installations in the selected project.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_package_installation_update", Description: "Check whether a package installation has an update.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_package_library", Description: "Search the hosted package library.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_shared_package", Description: "Inspect a package shared through a hosted package share token.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_preview_create_package", Description: "Preview package contents and validation issues before creating a package.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_preview_install_package", Description: "Preview package installation contents, requirements, and conflicts.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_preview_import_package", Description: "Preview package import contents, requirements, and conflicts.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_preview_shared_install", Description: "Preview installation of a shared package.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_preview_shared_import", Description: "Preview import of a shared package.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_object_versions", Description: "List promoted versions for a hosted object.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_active_version", Description: "Read the active production version for a hosted object.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_project_active_versions", Description: "List active production versions in the selected project.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_resource_access", Description: "List subjects with access to a hosted resource.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_resource_permissions", Description: "List the signed-in user's permissions for a hosted resource.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_resource_types_access", Description: "List hosted resource ids the signed-in user can access for a resource type.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_deletion_impact", Description: "Inspect hosted dependents, references, and shared resources before deletion.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_deleted_resources", Description: "List restorable hosted resources visible to the signed-in user.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_project_access", Description: "Read the selected project's resource access matrix.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_project_resources", Description: "Summarize resources in the selected project for governance and deletion planning.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_org_resources", Description: "List resources visible in the selected organization.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_org_members", Description: "List members of the selected organization.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_org_domains", Description: "List domains configured for the selected organization.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_org_sso", Description: "List SSO providers configured for the selected organization without client secrets.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_shared_with_me", Description: "List resources shared with the signed-in user.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_shared_by_me", Description: "List resources shared by the signed-in user.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_my_grants", Description: "List the signed-in user's hosted resource grants.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_teams", Description: "List organization teams.", ReadOnly: true},
		MCPTool{Name: "whodb_platform_team_members", Description: "List members of one organization team.", ReadOnly: true},
	)
	return tools
}
