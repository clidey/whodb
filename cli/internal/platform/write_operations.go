...
var platformMutationSpecs = map[string]platformMutationSpec{
	...
	"DeletePackage":                          mutationSpecWithDirect("DeletePackage", "$packageId: ID!", "packageId: $packageId", statusResponseFields),
	"InstallPackage":                         mutationSpecWithInput("InstallPackage", "InstallPackageInput", "installation { id sourceProjectId targetProjectId packageId packageName packageVersion packageChannel status installedBy installedAt updatedAt } items { sourceObjectId sourceObjectType sourceVersion sourceVisibility sourceImportable targetObjectId targetObjectType }"),
	"InstallPackageDeployment":               mutationSpecWithInput("InstallPackageDeployment", "InstallPackageDeploymentInput", "results { projectId sourceProjectId projectName projectCreated installation { id targetProjectId packageId packageName packageVersion status } error } successCount failureCount"),
	"InstallSharedPackage":                   mutationSpecWithInput("InstallSharedPackage", "SharedPackageOperationInput", "installation { id sourceProjectId targetProjectId packageId packageName packageVersion packageChannel status installedBy installedAt updatedAt } items { sourceObjectId sourceObjectType sourceVersion sourceVisibility sourceImportable targetObjectId targetObjectType }"),
	"UpdatePackageInstallation":              mutationSpecWithInput("UpdatePackageInstallation", "UpdatePackageInstallationInput", "installation { id sourceProjectId targetProjectId packageId packageName packageVersion packageChannel status installedBy installedAt updatedAt } items { sourceObjectId sourceObjectType sourceVersion sourceVisibility sourceImportable targetObjectId targetObjectType }"),
	"UpsertPackageInstallationCustomization": mutationSpecWithInput("UpsertPackageInstallationCustomization", "UpsertPackageInstallationCustomizationInput", "id installationId sourceObjectId sourceObjectType targetObjectId path mode content updatedBy createdAt updatedAt"),
	"DeletePackageInstallationCustomization": mutationSpecWithInput("DeletePackageInstallationCustomization", "DeletePackageInstallationCustomizationInput", statusResponseFields),
	"UninstallPackage":                       mutationSpecWithInput("UninstallPackage", "UninstallPackageInput", statusResponseFields),
	"ImportPackage":                          mutationSpecWithInput("ImportPackage", "ImportPackageInput", "installation { id sourceProjectId targetProjectId packageId packageName packageVersion packageChannel status installedBy installedAt updatedAt } items { sourceObjectId sourceObjectType sourceVersion sourceVisibility sourceImportable targetObjectId targetObjectType }"),
	"ImportSharedPackage":                    mutationSpecWithInput("ImportSharedPackage", "SharedPackageOperationInput", "installation { id sourceProjectId targetProjectId packageId packageName packageVersion packageChannel status installedBy installedAt updatedAt } items { sourceObjectId sourceObjectType sourceVersion sourceVisibility sourceImportable targetObjectId targetObjectType }"),
	...
	"RevokePackageShare":                     mutationSpecWithDirect("RevokePackageShare", "$shareId: ID!", "shareId: $shareId", statusResponseFields),
...
// older hosted schemas but accidentally absent from their platform manifest.
// Keep this compatibility list narrow; the server remains the authorization
// boundary and all other mutations must be advertised before use.
var permissionMutationsOmittedByLegacyManifests = map[string]struct{}{
	"GrantAccess":  {},
	"InviteUser":   {},
	"RevokeAccess": {},
	"ShareByEmail": {},
