...
var platformMutationSpecs = map[string]platformMutationSpec{
	"CreateSecret":               mutationSpecWithInput("CreateSecret", "PlatformSecret", projectSecretFields),
	"UpdateSecret":               mutationSpecWithInput("UpdateSecret", "PlatformSecret", projectSecretFields),
	"DeleteSecret":               mutationSpecWithProjectID("DeleteSecret", statusResponseFields),
	"CreateAIProvider":           mutationSpecWithInput("CreateAIProvider", "PlatformAIProvider", aiProviderFields),
	"UpdateAIProvider":           mutationSpecWithInput("UpdateAIProvider", "PlatformAIProvider", aiProviderFields),
	"DeleteAIProvider":           mutationSpecWithID("DeleteAIProvider", statusResponseFields),
	"CreateOntology":             mutationSpecWithInput("CreateOntology", "OntologyObjectType", ontologyFields),
	"UpdateOntology":             mutationSpecWithInput("UpdateOntology", "OntologyObjectType", ontologyFields),
	"DeleteOntology":             mutationSpecWithProjectID("DeleteOntology", statusResponseFields),
	"CreateOntologyFastLookup":   mutationSpecWithInput("CreateOntologyFastLookup", "OntologyFastLookup", ontologyFastLookupFields),
	"RemoveOntologyFastLookup":   mutationSpecWithProjectID("RemoveOntologyFastLookup", statusResponseFields),
	"CreateDataset":              mutationSpecWithInput("CreateDataset", "Dataset", datasetFields),
	"UpdateDataset":              mutationSpecWithInput("UpdateDataset", "Dataset", datasetFields),
	"DeleteDataset":              mutationSpecWithProjectID("DeleteDataset", statusResponseFields),
	"SaveTransform":              mutationSpecWithInput("SaveTransform", "Transform", transformFields),
