...
INSERT INTO test_schema.users (id, username, email, password, created_at) VALUES
...
INSERT INTO test_schema.products (id, name, description, price, stock_quantity, created_at) VALUES
...
INSERT INTO test_schema.orders (id, user_id, order_date, total_amount, status) VALUES
(2001, 1001, '2025-01-21 14:00:00', 2000.00, 'completed'),
(2002, 1002, '2025-01-21 15:30:00', 300.00, 'pending');

INSERT INTO test_schema.order_items (id, order_id, product_id, quantity, price_at_purchase) VALUES
(3001, 2001, 1001, 1, 1400.00),
(3002, 2001, 1002, 1, 600.00),
(3003, 2002, 1003, 2, 150.00);

INSERT INTO test_schema.payments (id, order_id, payment_date, amount, payment_method) VALUES
