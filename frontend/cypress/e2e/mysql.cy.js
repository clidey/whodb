...
describe('MySQL E2E test', () => {
    ...
    it('runs full MySQL E2E flow', () => {
        ...
        // 12) Test type casting behavior (related to issue #613 - MySQL specific)
        cy.data('test_casting');

        // Test adding a row with various numeric types that require casting
        // This is specifically testing the MySQL CAST AS SIGNED issue
        cy.getTableData().then(({rows}) => {
        ...
        // Navigate back to tables list before next test
