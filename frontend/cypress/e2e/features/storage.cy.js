...
describe('Browser Storage', () => {
    describe('Redux State Persistence', () => {
        forEachDatabase('sql', (db) => {
            describe(`${db.type}`, () => {                it('persists auth state across page reload', () => {
                    ...
                    cy.get('[data-testid="sidebar-database"], [data-testid="sidebar-schema"]')
                        .should('exist');
                });
    ...
    describe('Settings Persistence', () => {
        forEachDatabase('sql', (db) => {
            describe(`${db.type}`, () => {                it('persists storage unit view preference', () => {
                    cy.window().then((win) => {
    ...
    describe('Logout Storage Cleanup', () => {
        forEachDatabase('sql', (db) => {
            describe(`${db.type}`, () => {                it('clears Redux auth state on logout', () => {
    ...
    describe('Sidebar State Persistence', () => {
        forEachDatabase('sql', (db) => {
            describe(`${db.type}`, () => {                it('sidebar toggle state persists during navigation', () => {
    ...
    describe('Storage Size and Limits', () => {
        forEachDatabase('sql', (db) => {
            describe(`${db.type}`, () => {                it('localStorage contains expected data after login', () => {
                    cy.window().then((win) => {
    ...
    describe('Profile Management Storage', () => {
        forEachDatabase('sql', (db) => {
            describe(`${db.type}`, () => {                it('stores profile information in auth state', () => {
                    cy.window().then((win) => {
