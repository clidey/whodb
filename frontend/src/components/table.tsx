                    ...
                    <TableHeader>
                        <ContextMenu>
                            <ContextMenuTrigger asChild>
                                <TableRow className="group cursor-context-menu hover:bg-muted/50 transition-colors"
                                          title="Right-click for table options">
                    ...
                    <ContextMenu>
                        <ContextMenuTrigger asChild>
                            <div className="flex items-center justify-center h-full min-h-[500px] cursor-pointer">
                                <EmptyState title="No data available" description="No data available"
