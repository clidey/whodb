...
export const ImportData: FC<ImportDataProps> = ({
  ...
  const loadPreview = useCallback(async () => {
    ...
    setLoadingPreview(false);
  }, [buildOptions, dataFile, dataFormat, delimiter, objectRef]);
  ...
  const handleImportData = useCallback(async () => {
    ...
    if (!objectRef) {
      toast.error(t("previewValidationMissing"));
      return;
    }
              ...
              {mode === "data" ? (
                <>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start gap-sm">
                        <Checkbox
                          ...
                          data-testid="import-auto-generated-checkbox"
                        />
                  ...
                  {(preview || previewError || loadingPreview) && (
                    <div className="space-y-4" data-testid="import-preview-section">
                      {loadingPreview ? (
                        <div className="space-y-2" data-testid="import-preview-loading">
                      ...
                      <div className="space-y-2" data-testid="import-preview-error">
                        <Label>{t("previewTitle")}</Label>
                        ...
                        <>
                          <div className="space-y-2">
                            ...
                            <Select value={dataMode} onValueChange={(value) => setDataMode(value as ImportMode)}>
                              <SelectTrigger data-testid="import-data-mode-select">
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                          ...
                          <div className="space-y-2">
                            ...
                            {blockingValidationMessage && (
                              <div className="border border-destructive/40 bg-destructive/10 rounded-lg p-3 text-sm text-destructive" data-testid="import-validation-error">
                            ...
                            <div className="border rounded-lg overflow-hidden">
                              <div className="overflow-x-auto">
                                <table className="min-w-full text-sm" data-testid="import-preview-table">
                                  <thead>
                            ...
                            {previewIsTruncated && (
                              <p className="text-xs text-muted-foreground" data-testid="import-preview-truncated">{t("previewTruncated")}</p>
                            )}
                          </div>
                        </>
                      )}
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-40 border rounded-lg overflow-hidden" data-testid="import-sql-editor">
                      <CodeEditor
                        value={sqlText}
                        setValue={setSqlText}
                        language="sql"
                  ...
                  <div className="space-y-2">
                    <div className="flex items-start gap-sm">
                      <Checkbox
                        ...
                        data-testid="import-sql-confirm-checkbox"
                      />
