...
export const Card: FC<ICardProps> = ({
  ...
  return (
    <motion.div
      className={twMerge(
        classNames(
          "bg-white h-[200px] w-[200px] rounded-3xl shadow-xs border border-neutral-600/5 p-4 flex flex-col justify-between relative transition-all duration-300 overflow-y-auto dark:bg-[#252525] dark:border-white/5",
          {
