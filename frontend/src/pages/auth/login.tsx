            ...
            <div className="w-fit h-fit">
                    ...
                    <div className="flex grow">
                        <div className="flex flex-col gap-4 grow w-[350px]">
                            ...
                            <div className="flex flex-col grow justify-center gap-1">
                                <DropdownWithLabel fullWidth dropdownContainerHeight="max-h-[60px]" label="Database Type" value={databaseType} onChange={handleDatabaseTypeChange} items={databaseTypeDropdownItems} testId="database-type" />
                                {fields}
                            </div>
                        </div>
                        {
                ...
                </div>
                {
                    ...
                    <div className="mt-4 pt-2 border-t border-t-neutral-100/10 flex flex-col gap-2">
                        <DropdownWithLabel dropdownContainerHeight="max-h-[60px]" fullWidth label="Available profiles" value={selectedAvailableProfile} onChange={handleAvailableProfileChange}
