...
**EE Documentation**: All Enterprise Edition documentation, commands, and development guides are in `ee/GEMINI.md` and `ee/.claude/docs/`. This file covers CE only.
...
See `.claude/docs/commands.md` for full reference. EE commands are in `ee/GEMINI.md`.
