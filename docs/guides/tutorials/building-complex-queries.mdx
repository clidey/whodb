...
<Tip>
Queries become more readable when formatted with proper line breaks. Press Enter to add new lines as usual — queries only execute when you press Cmd+Enter (Ctrl+Enter on Windows/Linux) or click Run.
</Tip>
