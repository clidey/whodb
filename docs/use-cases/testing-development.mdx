...
<Accordion title="Larger datasets">
Use for:
- Load testing
...
Use repeated mock-data runs, imports, or database-native scripts when you need thousands of rows.
</Accordion>
</AccordionGroup>
...
Use `whodb-cli mock-data` or your own seed scripts to generate test data in CI/CD pipelines.
</Accordion>
